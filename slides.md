...
- Rust code can fail (overflow/underflow/etc.) 
  ...
  | div
  ```
- Aeneas is a tool which takes Rust code and extracts a model of that code in Lean
- Rust code is imperative (do notation with monadic bind)
  ```lean
...
**Spec and collaboration assistance:**
